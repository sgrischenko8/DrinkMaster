import{s as o,c as e,L as i,j as t,r as a,a as s}from"./index-a2179e53.js";import{W as c,F as l,T as d,a as h,S as m,b as x,c as p}from"./WelcomePage.styled-5b4ed95c.js";const g=o.div`
  display: flex;
  z-index: 2;
`,r=o(i)`
  margin-right: 14px;
...
`,y=o(u)`
  ...
  animation: ${b} 1s cubic-bezier(0.55, 0.085, 0.68, 0.53) both;

  @media screen and (min-width: 768px) {
    width: 45px;
    height: 45px;
  }
`,j=()=>t.jsx(y,{});function z(){return t.jsxs(c,{children:[t.jsxs(l,{children:[t.jsx(d,{children:"Welcome to the app!!"}),t.jsx(j,{})]}),t.jsx(h,{children:"This app offers more than just a collection of recipes - it is designed to be your very own digital cookbook. You can easily save and retrieve your own recipes at any time."}),t.jsx(m,{}),t.jsx(x,{}),t.jsx(p,{}),t.jsx(k,{})]})}export{z as default};
