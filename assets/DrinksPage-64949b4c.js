import{k as a,p as t,L as E,v as s,w as k,j as r,r as h,u as $,z as y,s as Q,A as b,C as f,D as w,E as F,F as T,G as M,P as N,y as A}from"./index-2733eaea.js";import{c as j,d as O,e as _,f as I,g as R,h as W,i as q}from"./dummyDrinkThumb-73564026.js";import{N as B,P as G}from"./Paginator-c2181bf1.js";import{S as H}from"./react-select.esm-25cca2f5.js";import{b as v}from"./useMediaQuery-72d24976.js";import"./img-blue-iced-tea-desktop@2x-9d8e6586.js";import"./ButtonBase-22c7bd02.js";import"./emotion-element-c39617d8.browser.esm-cf5a357f.js";import"./assertThisInitialized-f1d99751.js";import"./emotion-styled.browser.esm-d179cb5d.js";const J=a.ul`
  margin-top: 40px;
  display: flex;
...
`,Z=()=>{const{drinks:e}=s(j),o=s(k);return(e==null?void 0:e.length)!==0?r.jsx(J,{children:e==null?void 0:e.map(c=>r.jsxs(K,{children:[r.jsx(U,{src:c.drinkThumb,alt:c.drink,loading:"lazy",onError:d=>{d.currentTarget.src=O}}),r.jsxs(V,{children:[r.jsx(X,{theme:o,children:c.drink}),r.jsx(Y,{theme:o,to:`/drink/${c._id}`,children:"See more"})]})]},c._id))}):r.jsx(B,{message:"No cocktails found for your request"})},ee=a.div`
  margin-top: 40px;
  @media (min-width: 768px) {
    margin-top: 60px;
  }
