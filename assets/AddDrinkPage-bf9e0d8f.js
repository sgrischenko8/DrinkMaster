import{n as r,c as n,j as i,k as j,A as re,r as N,B as A,u as ne,C as ae,D as le,E as se,F as de,G as R,H as L,I as ce,J as pe,s as v,N as he,m as te,K as xe}from"./index-80ab3d5d.js";import{j as ge,k as me,l as P,d as oe,m as fe,n as ue,o as ye,P as be}from"./dummyDrinkThumb-ce7a5367.js";import{S as we}from"./react-select.esm-a8ebf0bb.js";import{c as W,a as D,d as ke,F as $e,e as je}from"./index.esm-738dd27b.js";import{H as ve,a as De,F as Ae}from"./Header-b26e5389.js";import{M as ze}from"./MainAppContainer-62ed0925.js";import"./assertThisInitialized-0e1cacc4.js";const Te=r.div`
  width: 100%;
  padding: 80px 0;
...
`,ki=v(he)`
  ...
  align-items: center;
  gap: 14px;
`,$i=()=>{const e=j(te),o=ne();N.useEffect(()=>{o(xe())},[o]);let a=j(ye);return i.jsx(xi,{theme:e,children:i.jsxs("div",{children:[i.jsx(gi,{children:"Popular drinks"}),i.jsx(mi,{children:a.map(l=>i.jsx(fi,{children:i.jsxs(ki,{to:`/drink/${l._id}`,children:[i.jsx(ui,{src:l.drinkThumb,alt:l.drink,onError:s=>{s.currentTarget.src=oe}}),i.jsxs(wi,{children:[i.jsx(bi,{theme:e,children:l.drink}),i.jsx(yi,{theme:e,children:l.description})]})]})},l._id))})]})})},Ii=()=>{const e=j(te);return i.jsxs(i.Fragment,{children:[i.jsx(ve,{}),i.jsx(ze,{children:i.jsxs(Te,{children:[i.jsx(be,{theme:e,title:"Add drink",marginMobile:"40px",marginTablet:"60px",marginDesktop:"60px"}),i.jsxs(Se,{children:[i.jsx(hi,{theme:e}),i.jsxs("div",{children:[i.jsxs(Ie,{children:[i.jsx(Ne,{theme:e,children:"Follow Us"}),i.jsx(De,{theme:e})]}),i.jsx($i,{})]})]})]})}),i.jsx(Ae,{})]})};export{Ii as default};
