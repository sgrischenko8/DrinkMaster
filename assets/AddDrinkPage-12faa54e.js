import{p as r,c as n,j as e,q as j,E as ai,r as I,F as A,f as G,h as D,G as li,u as ti,H as si,I as di,J as ci,K as pi,M as R,O as hi,P as xi,Q as gi,S as mi,s as v,N as fi,t as oi,U as ui,V as bi}from"./index-a2179e53.js";import{j as yi,k as wi,l as q,d as ri,m as ki,n as $i,o as ji,P as vi}from"./dummyDrinkThumb-39293631.js";import{S as Di}from"./react-select.esm-8a7439bd.js";import"./assertThisInitialized-df34482e.js";const Ai=r.div`
  display: flex;
...
`,be=v(fi)`
  ...
  align-items: center;
  gap: 14px;
`,ye=()=>{const i=j(oi),o=ti();I.useEffect(()=>{o(ui())},[o]);let a=j(ji);return e.jsx(ce,{theme:i,children:e.jsxs("div",{children:[e.jsx(pe,{children:"Popular drinks"}),e.jsx(he,{children:a.map(l=>e.jsx(xe,{children:e.jsxs(be,{to:`/drink/${l._id}`,children:[e.jsx(ge,{src:l.drinkThumb,alt:l.drink,loading:"lazy",onError:s=>{s.currentTarget.src=ri}}),e.jsxs(ue,{children:[e.jsx(fe,{theme:i,children:l.drink}),e.jsx(me,{theme:i,children:l.description})]})]})},l._id))})]})})},ve=()=>{const i=j(oi);return e.jsxs(e.Fragment,{children:[e.jsx(vi,{theme:i,title:"Add drink",marginMobile:"40px",marginTablet:"60px",marginDesktop:"60px"}),e.jsxs(Ai,{children:[e.jsx(de,{theme:i}),e.jsxs("div",{children:[e.jsxs(zi,{children:[e.jsx(Ti,{theme:i,children:"Follow Us"}),e.jsx(bi,{theme:i})]}),e.jsx(ye,{})]})]})]})};export{ve as default};
